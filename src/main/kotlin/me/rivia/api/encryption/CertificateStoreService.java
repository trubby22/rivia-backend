...
public class CertificateStoreService {
   ...
   */
  public boolean isDataSignatureValid(final byte[] encryptionKey,
      final String encryptedData, final String comparisonSignature) {
   ...
   */
  public String getDecryptedData(final byte[] encryptionKey,
